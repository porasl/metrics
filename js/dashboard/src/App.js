...
const Dashboard = () => {
  ...
  const orderPerMinOptions = {
    scales: {
      y: {
        beginAtZero: true,
        max: 25 // Increase the maximum value as needed
      }
    }
  };

  const orderPerHourOptions = {
    scales: {
      y: {
        beginAtZero: true,
        max: 600 // Increase the maximum value as needed
      }
    }
  };
    ...
    <div className="dashboard">
      ...
      <div className="charts" >
        <div className="chart" style={{ height: '250px' }}>
          <Bar data={orderPerMinData} style={{ height: '250px' }}/>
        </div>
        <div className="chart" style={{ height: '250px' }}>
          <Bar data={orderPerHourData} style={{ height: '250px' }}/>
        </div>
        <div className="chart" style={{ height: '220px' }}>
          <Doughnut data={paymentTypesData} style={{ height: '220px' }}/>
        </div>
      </div>
